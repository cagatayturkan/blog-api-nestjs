...
export class UserProjectsController {
  ...
  @ApiOperation({
    ...
    description:
      'Assign a user to a project using either ID or email, and project name',
  })
  @ApiResponse({
    status: 201,
  ...
  async unassignUserFromProject(
    ...
    return this.userProjectsService.unassignUserFromProject(
      userId,
      projectName,
    );
  }
  ...
  @Get('assignments')
  @ApiOperation({
    summary: 'Get all user-project assignments (Super Admin only)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Get all projects assigned to a user (Super Admin only)',
  })
  @ApiParam({
    name: 'userId',
    description: 'User ID',
  ...
  @ApiOperation({
    summary: 'Get all users assigned to a project (Super Admin only)',
  })
  @ApiParam({
    name: 'projectName',
    description: 'Project name',
